...
#removed UnionFind.hpp Movie.h ActorNode.h ActorEdge.h  from ActorGraph.o 
ActorGraph.o:  ActorGraph.h ActorGraph.cpp

DisjointSet.o:	DisjointSet.h DisjointSet.cpp

ExtensionGraph.o: ExtensionGraph.h ExtensionGraph.cpp
clean:
